...
from artiq.coredevice import urukul_mod
...
class AD9910:
    ...
    :param cpld_device: Name of the urukul_mod CPLD this device is on.
    ...
    def write16(self, addr: TInt32, data: TInt32):
        ...
        """
        self.bus.set_config_mu(urukul_mod.SPI_CONFIG | spi.SPI_END, 24,
                               urukul_mod.SPIT_DDS_WR, self.chip_select)
    ...
    def write32(self, addr: TInt32, data: TInt32):
        ...
        :param data: Data to be written
        """
        self.bus.set_config_mu(urukul_mod.SPI_CONFIG, 8,
                               urukul_mod.SPIT_DDS_WR, self.chip_select)
        self.bus.write(addr << 24)
        self.bus.set_config_mu(urukul_mod.SPI_CONFIG | spi.SPI_END, 32,
                               urukul_mod.SPIT_DDS_WR, self.chip_select)
        self.bus.write(data)
    ...
    def read16(self, addr: TInt32) -> TInt32:
        ...
        self.bus.set_config_mu(
            urukul_mod.SPI_CONFIG | spi.SPI_END | spi.SPI_INPUT,
            16, urukul_mod.SPIT_DDS_RD, self.chip_select)
        self.bus.write(0)
    ...
    def read32(self, addr: TInt32) -> TInt32:
        ...
        self.bus.set_config_mu(
            urukul_mod.SPI_CONFIG | spi.SPI_END | spi.SPI_INPUT,
            32, urukul_mod.SPIT_DDS_RD, self.chip_select)
        self.bus.write(0)
        return self.bus.read()
    ...
    def read64(self, addr: TInt32) -> TInt64:
        ...
        """
        self.bus.set_config_mu(
            urukul_mod.SPI_CONFIG, 8,
            urukul_mod.SPIT_DDS_WR, self.chip_select)
        self.bus.write((addr | 0x80) << 24)
        self.bus.set_config_mu(
            urukul_mod.SPI_CONFIG | spi.SPI_INPUT, 32,
            urukul_mod.SPIT_DDS_RD, self.chip_select)
        self.bus.write(0)
        self.bus.set_config_mu(
            urukul_mod.SPI_CONFIG | spi.SPI_END | spi.SPI_INPUT, 32,
            urukul_mod.SPIT_DDS_RD, self.chip_select)
        self.bus.write(0)
        hi = self.bus.read()
        lo = self.bus.read()
    ...
    def write64(self, addr: TInt32, data_high: TInt32, data_low: TInt32):
        ...
        self.bus.set_config_mu(urukul_mod.SPI_CONFIG, 8,
                               urukul_mod.SPIT_DDS_WR, self.chip_select)
        self.bus.write(addr << 24)
        self.bus.set_config_mu(urukul_mod.SPI_CONFIG, 32,
                               urukul_mod.SPIT_DDS_WR, self.chip_select)
    ...
    def write_ram(self, data: TList(TInt32)):
        ...
        """
        self.bus.set_config_mu(urukul_mod.SPI_CONFIG, 8, urukul_mod.SPIT_DDS_WR,
                               self.chip_select)
    ...
    def read_ram(self, data: TList(TInt32)):
        ...
        n = len(data) - 1
        if n > 0:
            self.bus.set_config_mu(urukul_mod.SPI_CONFIG | spi.SPI_INPUT, 32,
                                   urukul_mod.SPIT_DDS_RD, self.chip_select)
        preload = min(n, 8)
        for i in range(n):
            self.bus.write(0)
        ...
        self.bus.set_config_mu(
            urukul_mod.SPI_CONFIG | spi.SPI_INPUT | spi.SPI_END, 32,
            urukul_mod.SPIT_DDS_RD, self.chip_select)
        self.bus.write(0)
    ...
    def init(self, blind: TBool = False):
        ...
        if not blind:
            ...
            if aux_dac & 0xff != 0x7f:
                raise ValueError("urukul_mod AD9910 AUX_DAC mismatch")
            delay(50 * us)  # slack
        ...
        if self.pll_en:
            ...
            if blind:
                ...
                for i in range(100):
                    ...
                    lock = urukul_mod_sta_pll_lock(sta)
                    delay(1 * ms)
    ...
    def set_att_mu(self, att: TInt32):
        ...
        .. seealso:: :meth:`artiq.coredevice.urukul_mod.CPLD.set_att_mu`
    ...
    def set_att(self, att: TFloat):
        ...
        .. seealso:: :meth:`artiq.coredevice.urukul_mod.CPLD.set_att`
    ...
    def get_att_mu(self) -> TInt32:
        ...
        .. seealso:: :meth:`artiq.coredevice.urukul_mod.CPLD.get_channel_att_mu`
    ...
    def get_att(self) -> TFloat:
        ...
        .. seealso:: :meth:`artiq.coredevice.urukul_mod.CPLD.get_channel_att`
    ...
    def clear_smp_err(self):
        ...
        the respective urukul_mod channel.
    ...
    def tune_sync_delay(self,
        ...
        if not self.cpld.sync_div:
            raise ValueError("parent cpld does not drive SYNC")
        search_span = 31
        # FIXME https://github.com/sinara-hw/urukul_mod/issues/16
        ...
        for window in range(16):
            ...
            for in_delay in range(search_span - 2 * window):
                ...
                delay(100 * us)
                err = urukul_mod_sta_smp_err(self.cpld.sta_read())
                delay(100 * us)  # slack
